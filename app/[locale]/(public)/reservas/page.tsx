      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 pb-20 pt-28 lg:px-12 lg:pt-32">
        <section className="surface-dark-solid p-6 md:p-8">
          ...
          <p className="mt-5 max-w-3xl text-[15px] leading-8 text-white/68 md:text-lg">
            Consulte o status das suas reservas, acompanhe pagamentos pendentes e mantenha tudo organizado em um só lugar.
          </p>

          <div className="mt-6 flex flex-wrap items-center gap-3">
            <span className="chip-dark">
              <ShieldCheck className="h-3.5 w-3.5" />
              Fluxo mais claro e centralizado
            </span>
            <span className="chip-dark">
              <BadgeCheck className="h-3.5 w-3.5" />
              Acompanhamento de pagamento e status
            </span>
          </div>
        </section>
